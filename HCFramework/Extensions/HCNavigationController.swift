...
extension UINavigationController
{
    ...
    func hcGoBack(animated:Bool = true)
    {
    ...
    func hcPopToRootVC(animated:Bool = true)
    {
    ...
    func hcOpenVC(_ vc:UIViewController, animated:Bool = true, clearAll:Bool = false, popToVCIfExists:Bool = false, allowSameVC:Bool = false)
    {
    ...
    ///   - allowSameVC: Defines if it is allowed to open a view controller if a view controller wish same restorationIdentifier is already on the top of the navigation stack. Default value is false.
    func hcOpenVC(_ identifier:String, storyBoardName:String = "Main", animated:Bool = true, clearAll:Bool = false, popToVCIfExists:Bool = false, allowSameVC:Bool = false)
    {
    ...
    func hcGetVCForIdentifier(_ identifier:String, storyBoardName:String = "Main") -> UIViewController
    {
    ...
    static func hcTopVC(controller: UIViewController? = UIApplication.shared.keyWindow?.rootViewController) -> UIViewController? {
    ...
    static func hcGetNC() -> UINavigationController
    {
